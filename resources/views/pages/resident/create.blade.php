    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <div>
                    <h5 class="mb-0"><i class="ti ti-user-plus me-2"></i>Form Tambah Penduduk</h5>
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          ...
                                          placeholder="Masukkan alamat lengkap (RT/RW, Kelurahan, Kecamatan, dll)">{{ old('address') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                                    ...
                                    <option value="deceased" @selected(old('status') == 'deceased')>Meninggal Dunia</option>
                                </select>
